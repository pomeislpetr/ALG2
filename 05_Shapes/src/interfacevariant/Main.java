...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ShapeInterface> shapes3 = new ArrayList<>(); //Dynamicke pole objektu typu ShapeInterface
        //muze obsahovat cokoliv, co je typove kompatibilni s ShapeInterface (ShapeInterface, Circle, Rectangle)
        //Shape s = new Rectangle(5, 6);
        //Rectangle r = new ShapeInterface(); //nelze
        shapes3.add(c1);
        shapes3.add(r1);
